...
- 登录页：`/login`
- 工作台：`/`
  - 管理员视图：`总览 / 账户 / 计划 / 素材 / 经营拆解 / 批量上传 / 账号与权限 / 归属规则 / 预警中心`
  - 主管视图：`总览 / 账户 / 计划 / 素材 / 经营拆解`，如开启上传权限再显示 `批量上传`
  - 运营视图：`总览 / 我的素材 / 团队排名`
- 总览：KPI、系统状态、明细同步状态、老板关注提醒
- 账户：按账户看 `消耗 / 支付 / 订单 / ROI`，支持排序、搜索和 `日 / 昨日 / 近7天 / 近30天 / 指定日期范围`
- 经营拆解：商品榜和团队榜，支持排序、搜索、详情卡和 `日 / 昨日 / 近7天 / 近30天 / 指定日期范围`
- 计划：计划明细表 + 右侧详情栏 + 最近一次素材/商品摘要
- 素材：素材榜单 + 右侧素材详情，支持 `日 / 昨日 / 近7天 / 近30天 / 指定日期范围`，跨天按每日最后一次明细快照汇总
- 模块搜索统一为“当前表内字段搜索”，不是只搜名称
- 归属规则：管理员维护关键词归属、命中预览、人工绑定和未归属池
  - 未归属池支持 `账户 / 计划 / 商品 / 素材` 四类对象的一键绑定
- 账号与权限：维护后台账号、主管账户范围、运营关键词和主管素材上传权限
